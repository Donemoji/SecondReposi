...
namespace WhatisFunction {
    internal class MineGame {
         ...
         * debug 모드에서 지뢰가 아닌곳은 .(닷)으로 지뢰인 곳은 #(샵)으로 표현 
         * play mode 에서 확인 되지 않은 곳은 전부 □(스퀘어)로 표현 
         * 첫 턴에 지뢰를 밟으면 해당 칸의 지뢰를 지워 준다. 
         */ 
        ...
        public static void Main() {
             ...
             * -2: 지뢰 있음 
             * -1: 초기값
             * n: 주변 9타일 이내의 지뢰 수 (0일 경우 □표기, 양수일 경우 정수 표기) 
             * 
             * mineCntBoard 상태 
             * -1: 지뢰 있음 
             * n: 주변 9타일 이내의 지뢰 수 
            ...
            while(isGameOver == false) {
                ...
                // 현재 첫 턴이라면 해당 좌표에 지뢰가 있어도 지워 준다. 
            ...
            if(isPlayerWin) {
                Console.WriteLine("[플리이어] 지뢰를 모두 찾고 승리했습니다. ");
